...
public class SignUp extends javax.swing.JFrame {
    ...
    public SignUp(String role) {
        if (role == null || role.isEmpty()) {
            // Show an error message if the role is null or empty
            JOptionPane.showMessageDialog(this, "Please navigate to the log in page.", "Error", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }
        this.role = role;
